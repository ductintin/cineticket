...
function isButtonDisabled() {
  const showtimeIdInput = document.getElementsByName('showtimeId')[0] as HTMLInputElement;
  const dateInput = document.getElementsByName('date')[0] as HTMLInputElement;
  const theatreNameInput = document.getElementsByName('theatreName')[0] as HTMLInputElement;
